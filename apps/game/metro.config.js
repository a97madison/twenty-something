// Metro bundler config for the monorepo (mirrors apps/calculator).
//
...
// `import ... from "@twenty-something/core"` (or /ui) fails to resolve. The two
// settings below fix that:
//   - watchFolders: tell Metro to watch the whole monorepo, so changes in
//     packages/* trigger reloads and their files are bundleable.
