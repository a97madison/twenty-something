...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.serif, fontSize: 30, fontWeight: "700", color: colors.ink, marginTop: 8, marginBottom: 20 },
  ...
  cardTitle: { fontFamily: fonts.serif, fontSize: 20, fontWeight: "700", color: colors.accent, marginBottom: 14 },
  window: { gap: 10 },
  ...
  ratingNum: { fontFamily: fonts.serif, fontSize: 22, fontWeight: "700", color: colors.ink },
  ...
  metaValue: { fontFamily: fonts.serif, fontSize: 18, fontWeight: "700", color: colors.ink },
