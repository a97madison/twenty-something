...
const styles = StyleSheet.create({
  ...
  headlineNum: { fontFamily: fonts.serif, fontSize: 44, fontWeight: "700", color: colors.accent, marginTop: 8 },
  ...
  cellValue: { fontFamily: fonts.serif, fontSize: 20, fontWeight: "700", color: colors.ink, marginTop: 3 },
  ...
  deltaPrev: { fontFamily: fonts.serif, fontSize: 22, color: colors.inkDim },
  arrow: { fontFamily: fonts.sans, fontSize: 18, color: colors.inkFaint },
  deltaNew: { fontFamily: fonts.serif, fontSize: 30, fontWeight: "700", color: colors.ink },
  ...
  weeklyNum: { fontFamily: fonts.serif, fontSize: 22, fontWeight: "700", color: colors.ink },
  ...
  primaryText: { fontFamily: fonts.serif, fontSize: 17, fontWeight: "700", color: colors.accentInk },
